...
const VnProvinces = (): React.ReactElement => {
    ...
    return (
        <div style={{height: '100%', paddingTop: '10px', paddingLeft: '10px', paddingRight: '10px'}}>
            <p style={{paddingBottom: '10px'}}>Vietnamese Provinces</p>
            ...
            <div style={{paddingTop: '10px'}}>
                <RegionSelectionQuiz
                    ...
                    streakKey={getStreakKey(QuizType.VIETNAM_PROVINCES, [...enableRegion])}
