...
export const PatchNotes = (): React.ReactElement => {
    ...
    const dateNotesPairs: DatedComponent[] = [
        ...
        ['04-12-2025', <></>, "Added some more touches. Might pause the updates for a bit. Wage Cage calls.."],
        ...
        ['08-04-2026', <></>, "HUGE photo dump! I just quit my job so excited to work on some more projects :)"],
    ];
